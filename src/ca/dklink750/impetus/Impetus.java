...
public class Impetus extends JavaPlugin {
    ...
    private void registerEventListeners(PluginManager pluginManager) {
        pluginManager.registerEvents(new OnPlayerJoinEvent(getUser(), getPracLocations(), configManager.displayTimer()), this);
        pluginManager.registerEvents(new OnPlayerInteractEvent(getActivatorBlock(), getPracLocations(), configManager.getIneractablesToCancel(), configManager.getActivatorBlockTypes()), this);
        pluginManager.registerEvents(new OnPlayerDropEvent(configManager.practiceOnDrop(), configManager.makePluginItemsDroppable()), this);
        pluginManager.registerEvents(new OnPlayerBreakEvent(configManager.DestroyBlocksWhileHoldingPracticeTool(), configManager.DestroyActivatorBlocksWithoutPkTool(), getActivatorBlock()), this);
        pluginManager.registerEvents(new OnPlayerWorldChangeEvent(getPracLocations(), configManager.displayTimer()), this);
